...
from aoc2021.day1.measurement import get_number_of_increase_measurement, get_number_of_increase_measurement_in_three_sliding_window
...
@pytest.mark.puzzle
def test_get_number_of_increase_measurement_for_puzzle():
    puzzle_input = open("aoc2021/day1/input.txt", "r")
